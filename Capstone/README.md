...
A cost benefit analysis is conducted to evaluate the implications of the machine learning algorithm.   

The number of breast cancer diagnoses in Singapore from 2014 - 2018: 11,232 cases
Assuming the number of breast cancer diagnoses in Singapore per year:11,232/4 = 2,808 cases
Time taken for a pathologist to review a histopathological image: 15 mins

Breast pathologist salary in Singapore: $107,291 per annum [[source]](https://www.ziprecruiter.com/Salaries/Breast-Pathologist-Salary). Assuming a pathologist works 8 hours day, 5 days a week, 20 days per month, a rough estimation of how much they will earn is detailed below:

Amount pathologist earn per hour: $55.88 per hour

Approximate time taken for machine to detect presence of IDC for an individual: 30 secs (instantly to < 1 min) 
Assuming 30% of all images were identified as positive, additional time taken for a pathologist to validate/review the machine's results (identify False Positive): 4.5 mins

Total time taken to evaluate image, with machine learning: 5 mins
Time saved: 10 mins

Time taken to review breast histopathological images without machine learning per yr: 2,808 * 15 / 60 = 702 hr
Time taken to review breast histopathological images with machine learning per yr: 2,808 * 5 / 60 = 234 hr
Time saved per year: 702 - 234 = 468 hr

Pathologist cost to review breast histopathological images without machine learning per yr: 702 * $55.88 = $39,227.76
Pathologist cost to review breast histopathological images with machine learning per yr: 702 * $55.88 = $13,075.92
Cost savings per year = $26,151.84
